<template>
  <div id='pageheader'>
    <div :class="this._isMobile()? 'pageheaderMid_mobile' : 'pageheaderMid'">
        <div id='divLogo'>
            <a href="http://m.hachismart.com/">
            <img id='pageheaderlogo' @click="isDisplay?mobileMenuDisplay():''" :class="this._isMobile()?'logo_margin':''" src="./../../assets/images/header/puppyheaderlogo.png">
            </a>
        </div>
            ...
            <dl id="mobileMenuList" class="content">    
                    ...
                    <div class="menu_sublist_1">
                        <router-link to="/hachiinfinite">
                            <div :class="isWidthLess375?'icon_con_less_375':'icon_con'" @click="mobileMenuDisplay()">
                                <div><img class="icon" src="./../../assets/images/m_header/hachi_infinite.png"></div>
                                <div class="icon_title">哈奇光屏M1/M1 Pro</div>
                            </div>
                        </router-link>
                        <div class="space"></div>
                        <router-link to="/cubeX">
                            <div :class="isWidthLess375?'icon_con_less_375':'icon_con'" @click="mobileMenuDisplay()">
                                <div><img class="icon" src="./../../assets/images/m_header/icon_cube_s.png"></div>
                                <div class="icon_title">cube X</div>
                            </div>
                        </router-link>
                        <div class="space"></div>
                ...
                <dt>
                    ...
                    <div class="menu_sublist_2">
                        <router-link to="/hachibingo">
                            <div :class="isWidthLess375?'icon_con_less_375':'icon_con'" @click="mobileMenuDisplay()">
                                <div><img class="icon" style="width:35px !important;" src="./../../assets/images/m_header/bingo.png"></div>
                                <div class="icon_title">hachi bingo</div>
                            </div>
                        </router-link>
                        <div class="space"></div>
                        <router-link to="/hachiauto">
                            <div :class="isWidthLess375?'icon_con_less_375':'icon_con'" @click="mobileMenuDisplay()">
                                <div><img class="icon" style="width:57px !important; margin-left: 19px !important;" src="./../../assets/images/m_header/puppy_auto.png"></div>
                                <div class="icon_title">hachi auto</div>
                            </div>
                        </router-link>
                        <div class="space"></div>
                        <router-link to="/hachidelight">
                            <div :class="isWidthLess375?'icon_con_less_375':'icon_con'" @click="mobileMenuDisplay()">
                                <div><img class="icon" style="width:44px !important; margin-left: 24px !important;" src="./../../assets/images/m_header/hachi_delight.png"></div>
                                <div class="icon_title">hachi delight</div>
                            </div>
                        </router-link>
                ...
                <dt>
                    <div class="menu_title" @click="detailDisplay(5)">
                        <div class="m_con">
                            <div class="mtitle">智能家居</div>
                            <div class="arrow_contianer">
                                <img class="arrow_style" :src="menu5Display?require('./../../assets/images/m_header/arrow_up.png'):require('./../../assets/images/m_header/arrow_down.png')">
                            </div>
                        </div>
                    </div>
                    <div class="menu_sublist_5">
                        <router-link to="/hachisolution">
                            <div :class="isWidthLess375?'icon_con_less_375':'icon_con'" @click="mobileMenuDisplay()">
                                <div><img class="icon" style="width: 65px !important; margin-left: 0px; margin-top: 7px;" src="./../../assets/images/m_header/hachi_solution.png"></div>
                                <div class="icon_title" style="margin-left: -20px !important; margin-top: 15px;">解决方案</div>
                            </div>
                        </router-link>
                        <router-link to="/hachiproduct">
                            <div :class="isWidthLess375?'icon_con_less_375':'icon_con'" @click="mobileMenuDisplay()">
                                <div><img class="icon" style="width:75px !important; margin-left: 5px; margin-top: 22px;" src="./../../assets/images/m_header/hachi_product.png"></div>
                                <div class="icon_title"  style="margin-left: -7px !important; margin-top: 28px;" >产品中心</div>
                            </div>
                        </router-link>
                        <router-link to="/hachicases">
                            <div :class="isWidthLess375?'icon_con_less_375':'icon_con'" @click="mobileMenuDisplay()">
                                <div><img class="icon" style="width:58px !important; margin-left: 30px;" src="./../../assets/images/m_header/hachi_cases.png"></div>
                                <div class="icon_title" style="margin-left: 10px !important;">应用案例</div>
                            </div>
                        </router-link>
                    </div>
                </dt>      
                <dt>
                    <div class="menu_title" @click="detailDisplay(4)">
                        <div class="m_con">
                            <div class="mtitle">AI 技术方案</div>
                            <div class="arrow_contianer">
                                <img class="arrow_style" :src="menu4Display?require('./../../assets/images/m_header/arrow_up.png'):require('./../../assets/images/m_header/arrow_down.png')">
                            </div>
                        </div>
                    </div>
                    <div class="menu_sublist_4">
                        <router-link to="/aiot">
                            <div :class="isWidthLess375?'icon_con_less_375':'icon_con'" @click="mobileMenuDisplay()">
                                <div><img class="icon" style="width: 65px !important; margin-left: 0px; margin-top: 7px;" src="./../../assets/images/m_header/aiot.png"></div>
                                <div class="icon_title" style="margin-left: -20px !important;">AIoT 技术</div>
                            </div>
                        </router-link>
                        <router-link to="/robottech">
                            <div :class="isWidthLess375?'icon_con_less_375':'icon_con'" @click="mobileMenuDisplay()">
                                <div><img class="icon" style="width:75px !important; margin-left: 5px; margin-top: 12px;" src="./../../assets/images/m_header/robot.png"></div>
                                <div class="icon_title"  style="margin-left: -7px !important;" >机器人技术</div>
                            </div>
                        </router-link>
                        <router-link to="/aisighttech">
                            <div :class="isWidthLess375?'icon_con_less_375':'icon_con'" @click="mobileMenuDisplay()">
                                <div><img class="icon" style="width:58px !important; margin-left: 30px;" src="./../../assets/images/m_header/smartsight.png"></div>
                                <div class="icon_title" style="margin-left: 10px !important;">智能视觉技术</div>
                            </div>
                        </router-link>
                    </div>
                </dt>  
                    ...
                    <div class="menu_sublist_3" style="height: 380px !important;">
                        <router-link to="/aboutus">
                            <div :class="isWidthLess375?'icon_con_less_375':'icon_con'" @click="mobileMenuDisplay()">
                                ...
                                <div class="icon_title" style="margin-left: -20px !important;">公司介绍</div>
                            </div>
                        </router-link>
                        <router-link to="/cooperate">
                            <div :class="isWidthLess375?'icon_con_less_375':'icon_con'" @click="mobileMenuDisplay()">
                                <div><img class="icon" style="width:75px !important; margin-left: 10px; margin-top: 8px;" src="./../../assets/images/m_header/business.png"></div>
                                <div class="icon_title"  style="margin-left: -2px !important;" >商务合作</div>
                            </div>
                        </router-link>
                        <router-link to="/contact">
                            <div :class="isWidthLess375?'icon_con_less_375':'icon_con'" @click="mobileMenuDisplay()">
                                <div><img class="icon" style="width:58px !important; margin-left: 30px;" src="./../../assets/images/m_header/contact.png"></div>
                                <div class="icon_title" style="margin-left: 10px !important;">联系我们</div>
                            </div>
                        </router-link>
                        <router-link to="/newscenter">
                            <div :class="isWidthLess375?'icon_con_less_375':'icon_con'" @click="mobileMenuDisplay()">
                                <div><img class="icon" style="width:55px !important; margin-left: 0px !important; margin-top: 20px;" src="./../../assets/images/m_header/media.png"></div>
                                <div class="icon_title" style="margin-left: -20px !important;">媒体中心</div>
                            </div>
                        </router-link>
                        <router-link to="/videocenter">
                            <div :class="isWidthLess375?'icon_con_less_375':'icon_con'" @click="mobileMenuDisplay()">
                                <div><img class="icon" style="width:65px !important; margin-left: 10px !important; margin-top: 30px;" src="./../../assets/images/m_header/video.png"></div>
                                <div class="icon_title" style="margin-left: -5px !important; margin-top: 10px;">视频中心</div>
                            </div>
                        </router-link>
                         <router-link to="/techsupport">
                            <div :class="isWidthLess375?'icon_con_less_375':'icon_con'" @click="mobileMenuDisplay()">
                                <div><img class="icon" style="width:40px !important; margin-left: 40px !important; margin-top: 30px;" src="./../../assets/images/m_header/support.png"></div>
                                <div class="icon_title" style="margin-left: 8px !important; margin-top: 2px;">技术支持</div>
                            </div>
                        </router-link>
                         <!-- <router-link to="/campusrecruitment">
                            <div :class="isWidthLess375?'icon_con_less_375':'icon_con'" @click="mobileMenuDisplay()">
                                <div><img class="icon" style="width:55px !important; margin-left: 0px !important; margin-top: 20px;" src="./../../assets/images/m_header/campus.png"></div>
                                <div class="icon_title" style="margin-left: -20px !important;">校园招聘</div>
                            </div>
                        </router-link> -->
                    </div>
                </dt>  
